...
class WytrawnosciDetailedPost extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        const show = sorted.length > 0 &&
            <div data-aos="zoom-out"
                ...
                <div className="detailed-post-nav">
                    <div className="detailed-post-nav-left"><strong>slodkanitka</strong> &gt; <a>wytrawności</a></div>
...
export {WytrawnosciDetailedPost}
