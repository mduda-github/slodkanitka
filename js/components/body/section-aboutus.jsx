        ...
        return <section className="aboutus">
            <div className="container">
                ...
                <p>Rasowa Kura Domowa, wieczny student, żona cudownego Męża, mama dwóch słodziaków i właścicielka
                    żółtego psa :) Poza tym pasjonatka życia, uzależniona od doświadczania go w pełnym jego wymiarze z
                ...
                <p>Wesoła i trochę roztrzepana gosposia. Żona ukochanego Męża. Właścicielka pary uroczych czworonogów -
                    tego mądrego i tej ładnej. Absolwentka UW na kierunku przyrodniczym, pracownik korporacji w branży
                    ...
                    objawiające się w ludziach i świecie. Lubi smacznie zjeść, najchętniej z własnej kuchni. A jeszcze
                    lepiej, podzielić się z bliskimi, tym czym została obdarowana. Cześć, jestem <strong>Klaudyna</strong>.</p>
            </div>
        </section>
    }
}
